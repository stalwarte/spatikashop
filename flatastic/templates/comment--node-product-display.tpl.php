...
<article>
    <div class="clearfix m_bottom_10">
        <p class="f_size_medium f_left f_mxs_none m_mxs_bottom_5"><?php print $author;?> - <?php print format_date($comment->created,'custom','F j, Y, g:i a');?></p>
        <!--rating-->

    </div>
    <?php if(isset($comment->comment_body['und'])):?>
    <p class="m_bottom_15"><?php print $comment->comment_body['und'][0]['value'];?></p>
    <?php endif;?>
</article>
