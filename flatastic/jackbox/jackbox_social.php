    ...
    <head>
        ...
        <style type="text/css">
			...
			.twitter-webkit {
				...
				background: url(social/twitter_webkit.png) no-repeat !important;
				
			}
			
			.twitter-mac {
			
				background: url(social/twitter_mac.png) no-repeat !important;
			...
			#pinterest, #pinterest-mask {
				...
				height: 22px;
				overflow: hidden;
				background: url(social/pinterest.png) no-repeat;
			...
			.facebook-mac {
				...
				background: url(social/facebook_mac.png) no-repeat !important;
